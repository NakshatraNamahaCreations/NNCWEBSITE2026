// ── Mobile App Development Mysuru Landing Page Data ──────────────────────────

export const MYSURU_APP_PAGE = {
  slug: '/mobile-app-development-mysuru',
  title: 'Mobile App Development Company in Mysuru | Nakshatra Namaha Creations',
  description:
    'Leading mobile app development company in Mysuru. Custom Android & iOS apps on React Native & Flutter. 150+ apps delivered. 4.9★ Google. Walk-in Mysuru office. Fixed price. Source code yours. Call +91 99005 66466.',
  keywords: [
    'mobile app development company in mysuru',
    'mobile app development mysuru',
    ...
    'app development company mysuru',
    'mobile app developers mysuru',
    'custom mobile app development mysuru',
    'on demand app development mysuru',
    'ecommerce app development mysuru',
    'best app development company mysuru',
    'app developers near me mysuru',
    'mobile application development mysore',
    'app development company mysore',
  ],
  heroHeadline: ['Mysuru\u2019s Trusted Mobile', 'App Development Partner'],
  heroSub:
    'Custom Android & iOS apps built by a 35+ member in-house team with a walk-in office in JP Nagar, Mysuru. React Native, Flutter, zero outsourcing. 150+ apps delivered. Fixed price. Source code 100% yours.',
  breadcrumb: [
    { label: 'Home', href: '/' },
    { label: 'Services', href: '/#services' },
    { label: 'Mobile App Development', href: '/mobile-app-development-company-in-bangalore' },
    { label: 'Mysuru', href: null },
  ],
}

export const MYSURU_APP_STATS = [
...
export const MYSURU_APP_TECH = [
  { name: 'React Native', desc: 'Single codebase for Android & iOS. Near-native performance. Ideal for most business apps in Mysuru.', ico: 'M12 2L2 7l10 5 10-5-10-5M2 17l10 5 10-5M2 12l10 5 10-5', tag: 'Cross-platform' },
...
export const MYSURU_APP_PROCESS = [
  { n: '01', title: 'Requirement Discovery',   desc: 'We map your complete user journey, feature list and tech requirements. Visit our Mysuru office or connect remotely.', time: 'Day 1' },
...
export const MYSURU_APP_FEATURES = [
...
export const MYSURU_APP_PRICING = [
  {
    tier: 'MVP / Startup',
    price: '₹75,000',
    priceGst: '₹88,500',
...
export const MYSURU_APP_PORTFOLIO = [
  {
...
export const MYSURU_APP_FAQS = [
  {
    q: 'How much does mobile app development cost in Mysuru?',
  ...
  {
    q: 'Does NNC have a physical office in Mysuru?',
    a: 'Yes. Our Mysuru branch office is at Suswani Towers, JP Nagar 2nd Stage, Mysuru – 570 008. Walk in Mon–Sat, 9am–7pm to meet your project team in person.',
  },
  {
...
export const MYSURU_APP_TESTIMONIALS = [
  {
